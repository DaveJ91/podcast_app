...
// Update Show - GET
exports.show_update_get = function(req, res, next){

    async.parallel({

        // Get Show, People, Podcasts
        show: function(callback){
            Show.findById(req.params.id)
                .exec(callback)
        },
        ...
        res.render('show_form', {title:'Update Show', show:results.show, people:results.people, podcasts:results.podcasts })
